	...
	public Controller(int joystickPort){
		joystick = new Joystick(joystickPort){
			...
			public double getRawAxis(int axis){
				if (axis == 0 || axis == 1) {
					return Utilities.newdeadband2(super.getRawAxis(0), super.getRawAxis(1), 0.23)[axis];
				} else if (axis == 4 || axis == 5) {
					return Utilities.newdeadband2(super.getRawAxis(4), super.getRawAxis(5), 0.23)[axis-4];
				} else {
